tags$div(
  p(
    ...
    "about the organization responsible for the monitoring effort.",
   "Links to the program websites and data are included in the inventory."),
    
  p(
    "There are primary, secondary and tertiary filters available to help narrow down a search.",
    'To filter the inventory for certain program characteristics (e.g. site location, program name, and parameter',
    'group), select the inventory "Column" and "Option" that are of interest.',
    'The resulting "Program" table',
    'shows the filtered data in a tabular format. To download the filtered data, click on the "Download" tab',
    'and then "Download Program Data". If no filter was selected, all of the data in the Water Quality Data',
